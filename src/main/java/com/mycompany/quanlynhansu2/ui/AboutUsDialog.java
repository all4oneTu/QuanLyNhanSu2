...
public class AboutUsDialog extends javax.swing.JDialog {
    ...
    public AboutUsDialog(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
        setLocationRelativeTo(parent); // đặt dialog nằm giữa
    }
    ...
    private void initComponents() {
        ...
        jLabel1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/com/mycompany/quanlynhansu2/icons/Person-Male-Light-icon-48.png"))); // NOI18N
    ...
    private void btnCloseActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnCloseActionPerformed
        this.dispose(); // dong hop thoai nhung khong dong chuong trinh
